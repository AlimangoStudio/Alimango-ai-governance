...
1. Read `README.md`, `GOVERNANCE.md`, and `AGENTS.md`.
2. Pick a concrete failure mode from `docs/FAILURE-MODE-CATALOG.md` or propose one.
3. Start with a small issue/proposal that states failure mode, control, bypasses, and evidence.
...
7. Open a focused PR; keep private/proprietary information out.
